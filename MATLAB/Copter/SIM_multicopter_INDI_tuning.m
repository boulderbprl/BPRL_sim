...
function [motor_pwm,target,state] = update_control(target,state,dt)
...
function c = build_controllers(copter)
    ...
    % ── Rates ────────────────────────────────────────────────────────────
    c.rate_roll  = controller_PID(G('rate_roll_Kp', 0.135), G('rate_roll_Ki', 0.135), ...
                                  G('rate_roll_Kd', 0.0),   0, 0.444, 20);
    c.rate_pitch = controller_PID(G('rate_pitch_Kp',0.135), G('rate_pitch_Ki',0.135), ...
                                  G('rate_pitch_Kd',0.0),   0, 0.444, 20);
