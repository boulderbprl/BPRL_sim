 function flight_data = import_ardupilot_data_esc(filename, globalTime)
    ...
    try
        ...
        control_time = HMS_to_sec_no_offset(timetable2table(control_data(:,1)));
    ...
    try
        ...
        esc_data11 = esc_data_raw.MsgData{3,1};
        esc_data12 = esc_data_raw.MsgData{4,1};

        
        % Extract control data
        esc1_time = HMS_to_sec_no_offset(timetable2table(esc_data9(:,1)));
        
        esc2_time = HMS_to_sec_no_offset(timetable2table(esc_data10(:,1)));
        
        esc3_time = HMS_to_sec_no_offset(timetable2table(esc_data11(:,1)));
        esc4_time = HMS_to_sec_no_offset(timetable2table(esc_data12(:,1)));
        

        esc1 = timetable2table(esc_data9(:,3));
        esc1 = table2array(esc1(:,2));
        
        esc2 = timetable2table(esc_data10(:,3));
        esc2 = table2array(esc2(:,2));
    
        esc3 = timetable2table(esc_data11(:,3));
        esc3 = table2array(esc3(:,2));

        esc4 = timetable2table(esc_data12(:,3));
        esc4 = table2array(esc4(:,2));
        

        
        % Interpolate control inputs
        flight_data.esc_inputs = [
            interp1(esc1_time, esc1, globalTime, 'linear') , ...
            interp1(esc2_time, esc2, globalTime, 'linear') , ...
            interp1(esc3_time, esc3, globalTime, 'linear') , ...
            interp1(esc4_time, esc4, globalTime, 'linear')
        ];
    
    catch ME
        warning('Could not extract esc data: %s', string(ME.message));
        flight_data.exc_inputs = nan(length(globalTime), 4);
    end
    ...
    try
        ...
        ATT_raw = readMessages(arduObj, 'MessageName', {'ATT'});
        ...
        pitch = timetable2table(ATT_data(:,5)); 
        pitch = table2array(pitch(:,2));

        yaw = timetable2table(ATT_data(:,7)); 
    ...
    % try
    %     [strain_arm_1, strain_arm_2, strain_arm_3, strain_arm_4, ~] = ...
    %         import_strain_data(globalTime, arduObj);
    % 
...
function [strain_arm_1 , strain_arm_2, strain_arm_3 ,strain_arm_4 , strain_avg] = import_strain_data(globalTime,arduObj)
    ...
    a1_s4_tab = timetable2table( strain_sensor1_data(:,5)  );
    a1_s5_tab = timetable2table( strain_sensor1_data(:,6)  );
    a1_s6_tab = timetable2table( strain_sensor1_data(:,7)  );
    
    a1_s1 = table2array(  a1_s1_tab(:,2)  );
    a1_s2 = table2array(  a1_s2_tab(:,2)  );
    a1_s3 = table2array(  a1_s3_tab(:,2)  );
    a1_s4 = table2array(  a1_s4_tab(:,2)  );
    a1_s5 = table2array(  a1_s5_tab(:,2)  );
    a1_s6 = table2array(  a1_s6_tab(:,2)  );

    %%% arm 2
    a2_s1_tab = timetable2table( strain_sensor1_data(:,8)  );
    a2_s2_tab = timetable2table( strain_sensor1_data(:,9)  );
    a2_s3_tab = timetable2table( strain_sensor1_data(:,10)  );
    a2_s4_tab = timetable2table( strain_sensor1_data(:,11)  );
    a2_s5_tab = timetable2table( strain_sensor1_data(:,12)  );
    a2_s6_tab = timetable2table( strain_sensor1_data(:,13)  );
    
    a2_s1 = table2array(  a2_s1_tab(:,2)  );
    a2_s2 = table2array(  a2_s2_tab(:,2)  );
    a2_s3 = table2array(  a2_s3_tab(:,2)  );
    a2_s4 = table2array(  a2_s4_tab(:,2)  );
    a2_s5 = table2array(  a2_s5_tab(:,2)  );
    a2_s6 = table2array(  a2_s6_tab(:,2)  );
    ...
    a3_s4_tab = timetable2table( strain_sensor2_data(:,5)  );
    a3_s5_tab = timetable2table( strain_sensor2_data(:,6)  );
    a3_s6_tab = timetable2table( strain_sensor2_data(:,7)  );
    
    a3_s1 = table2array(  a3_s1_tab(:,2)  );
    a3_s2 = table2array(  a3_s2_tab(:,2)  );
    a3_s3 = table2array(  a3_s3_tab(:,2)  );
    a3_s4 = table2array(  a3_s4_tab(:,2)  );
    a3_s5 = table2array(  a3_s5_tab(:,2)  );
    a3_s6 = table2array(  a3_s6_tab(:,2)  );

    %%% arm 2
    a4_s1_tab = timetable2table( strain_sensor2_data(:,8)  );
    a4_s2_tab = timetable2table( strain_sensor2_data(:,9)  );
    a4_s3_tab = timetable2table( strain_sensor2_data(:,10)  );
    a4_s4_tab = timetable2table( strain_sensor2_data(:,11)  );
    a4_s5_tab = timetable2table( strain_sensor2_data(:,12)  );
    a4_s6_tab = timetable2table( strain_sensor2_data(:,13)  );
    
    a4_s1 = table2array(  a4_s1_tab(:,2)  );
    a4_s2 = table2array(  a4_s2_tab(:,2)  );
    a4_s3 = table2array(  a4_s3_tab(:,2)  );
    a4_s4 = table2array(  a4_s4_tab(:,2)  );
    a4_s5 = table2array(  a4_s5_tab(:,2)  );
    a4_s6 = table2array(  a4_s6_tab(:,2)  );

    %%% avg
    strain_avg_tab = timetable2table(strain_sensor1_data(:,14));
    strain_avg = table2array(strain_avg_tab(:,2));
    ...
    strain_arm1 = [a1_s1,a1_s2,a1_s3,a1_s4,a1_s5,a1_s6];
    strain_arm2 = [a2_s1,a2_s2,a2_s3,a2_s4,a2_s5,a2_s6];
    strain_arm3 = [a3_s1,a3_s2,a3_s3,a3_s4,a3_s5,a3_s6];
    strain_arm4 = [a4_s1,a4_s2,a4_s3,a4_s4,a4_s5,a4_s6];
    ...
    strain_avg = interp1( strain_arm1_time, strain_avg, globalTime, 'linear');
